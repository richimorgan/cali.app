var DB_RAW = {
  "esercizi": [
...
},
    {
      ...
      "categoria": "tirata",
      "tipo": "forza",
      "muscoli": ["bicipiti", "avambracci"],
      "difficolta": 2,
      "attrezzo": ["sbarra bassa"],
      "propedeutico_a": ["chin_up"],
      "richiede": [],
      "recupero": 60,
      "skill_target": false,
      "pattern": "horizontal_pull",
      "fase": "potenziamento",
      "sets": { "leggero": "3x8", "standard": "3x12", "intenso": "4x15" },
      "media": null,
      "descrizione": "Sotto la sbarra bassa con presa supina larga quanto le spalle, corpo inclinato e braccia tese. Tieni i gomiti fermi e porta la fronte verso la sbarra flettendo solo i gomiti, poi abbassa controllato. A differenza dell'australian row, qui le spalle rimangono ferme — il movimento è puro di gomito. Senti lavorare: bicipiti e brachiale in isolamento. Errore comune: far oscillare le spalle verso la sbarra invece di tirare solo con i gomiti."
    },
    {
      "id": "tricep_extension_sbarra",
      "name": "Tricep Extension su sbarra",
      "categoria": "spinta",
      "tipo": "forza",
      "muscoli": ["tricipiti"],
      "difficolta": 2,
      "attrezzo": ["sbarra bassa"],
      "propedeutico_a": ["diamond_push_up", "russian_dips"],
      "richiede": ["tricep_pushdown_elastico"],
      "recupero": 60,
      "skill_target": false,
      "pattern": "horizontal_push",
      "fase": "potenziamento",
      "sets": { "leggero": "3x6", "standard": "3x10", "intenso": "4x12" },
      "media": null,
      "descrizione": "In piedi davanti alla sbarra bassa, prendi la sbarra con presa prona larga quanto le spalle e inclinati in avanti con braccia tese. Piega solo i gomiti abbassando la testa sotto la sbarra, poi estendi tornando alla posizione di partenza. Più il corpo è inclinato (orizzontale), più è difficile. Senti lavorare: tricipiti in isolamento, in particolare il capo lungo. Errore comune: piegare anche le spalle in avanti invece di bloccarle e muovere solo i gomiti."
    },
    {
      "id": "sphinx_push_up",
      "name": "Sphinx Push-up",
      "categoria": "spinta",
      "tipo": "forza",
      "muscoli": ["tricipiti", "spalle", "core"],
      "difficolta": 3,
      "attrezzo": ["terra"],
      "propedeutico_a": ["diamond_push_up"],
      "richiede": ["push_up", "tricep_extension_sbarra"],
      "recupero": 75,
      "skill_target": false,
      "pattern": "horizontal_push",
      "fase": "potenziamento",
      "sets": { "leggero": "3x5", "standard": "3x8", "intenso": "4x10" },
      "media": null,
      "descrizione": "Posizione di plank basso con gli avambracci a terra e gomiti sotto le spalle. Estendi i gomiti spingendo fino a braccia tese senza spostare le spalle, poi torna sugli avambracci. È il bodyweight skull crusher: le spalle rimangono ferme, si muovono solo i gomiti. Senti lavorare: tricipiti in modo molto diretto, specie il capo lungo. Errore comune: spingere con le spalle verso l'alto trasformandolo in un movimento di alzata invece di estendere solo i gomiti."
    },
    {
      "id": "straight_bar_dip",
      ...
      "categoria": "spinta",
      "tipo": "forza",
      "muscoli": ["tricipiti", "petto", "spalle"],
      "difficolta": 3,
      "attrezzo": ["sbarra"],
      "propedeutico_a": ["russian_dips", "muscle_up"],
      "richiede": ["dips", "dips_assistiti"],
      "recupero": 90,
      "skill_target": false,
      "pattern": "horizontal_push",
      "fase": "potenziamento",
      "sets": { "leggero": "3x5", "standard": "3x8", "intenso": "4x10" },
      "media": null,
      "descrizione": "Prendi la sbarra frontale con presa prona larga quanto le spalle, sollevati a braccia tese con la sbarra all'altezza dei fianchi. Inclina leggermente il busto in avanti e piega i gomiti abbassando il corpo fino a 90°, poi spingi su. I gomiti scorrono vicini al busto verso dietro, non lateralmente. Senti lavorare: tricipiti come muscolo primario, petto e deltoide anteriore. Errore comune: lasciare i gomiti svasare lateralmente, che toglie enfasi ai tricipiti."
    },
    {
      "id": "wall_walk",
      "name": "Wall Walk",
      "categoria": "spinta",
      "tipo": "mix",
      "muscoli": ["spalle", "tricipiti", "core", "petto"],
      "difficolta": 3,
      "attrezzo": ["muro"],
      "propedeutico_a": ["handstand_hold", "handstand_push_up_wall"],
      "richiede": ["wall_handstand", "pike_push_up_elevato"],
      "recupero": 90,
      "skill_target": false,
      "pattern": "vertical_push",
      "fase": "skill",
      "sets": { "leggero": "3x2", "standard": "3x4", "intenso": "4x5" },
      "media": null,
      "descrizione": "Parti in posizione di plank con i piedi contro il muro. Cammina con i piedi su per il muro mentre le mani si avvicinano al muro, fino ad arrivare quasi verticale. Poi torna alla posizione di plank invertendo il cammino. Mantieni il corpo rigido durante tutta la salita e discesa. Senti lavorare: spalle, tricipiti e core in modo dinamico nel range verticale. Errore comune: inarcare la schiena durante la salita invece di mantenere il corpo rigido."
    },
    {
      "id": "prone_iyt_raises",
      ...
      "categoria": "tirata",
      "tipo": "forza",
      "muscoli": ["deltoide posteriore", "trapezio", "romboidi", "spalle"],
      "difficolta": 1,
      "attrezzo": ["terra"],
      "propedeutico_a": ["face_pull_elastico", "rear_pull_up"],
      "richiede": [],
      "recupero": 45,
      "skill_target": false,
      "pattern": "horizontal_pull",
      "fase": "potenziamento",
      "sets": { "leggero": "2x8", "standard": "3x10", "intenso": "3x12" },
      "media": null,
      "descrizione": "A pancia in giù con braccia tese. Esegui tre varianti in sequenza: I — solleva le braccia dritte in avanti (puntano alle 12); Y — sollevale in diagonale a 45° (puntano alle 11 e 1); T — sollevale lateralmente a 90° (puntano alle 9 e 3). In ogni posizione tieni 1-2 secondi poi abbassa. Senti lavorare: deltoide posteriore, trapezio medio e romboidi con enfasi diversa per ogni forma. Errore comune: usare il momentum e non tenere la posizione in cima, perdendo il lavoro isometrico."
    },
    {
      ...
      "categoria": "tirata",
      "tipo": "forza",
      "muscoli": ["deltoide posteriore", "romboidi", "trapezio", "lombari"],
      "difficolta": 1,
      "attrezzo": ["terra"],
      "propedeutico_a": ["prone_iyt_raises", "band_pull_apart"],
      "richiede": ["arch_body"],
      "recupero": 45,
      "skill_target": false,
      "pattern": "horizontal_pull",
      "fase": "potenziamento",
      "sets": { "leggero": "2x10", "standard": "3x12", "intenso": "3x15" },
      "media": null,
      "descrizione": "A pancia in giù in posizione Superman con petto e braccia sollevati da terra, braccia tese avanti. Porta le braccia in un ampio arco circolare dai fianchi verso la testa e ritorna, come un angelo della neve al contrario. Mantieni le braccia sollevate da terra per tutto il movimento. Senti lavorare: deltoide posteriore, romboidi e trapezio medio in modo dinamico. Errore comune: appoggiare le braccia a terra durante il movimento invece di tenerle sempre in aria."
    },
    {
      "id": "wrist_push_up",
      "name": "Wrist Push-up",
      "categoria": "core",
      "tipo": "forza",
      "muscoli": ["avambracci", "polsi", "spalle"],
      "difficolta": 2,
      "attrezzo": ["terra"],
      "propedeutico_a": ["planche_lean", "wall_handstand"],
      "richiede": ["push_up"],
      "recupero": 45,
      "skill_target": false,
      "pattern": "core",
      "fase": "core",
      "sets": { "leggero": "2x5", "standard": "3x8", "intenso": "3x10" },
      "media": null,
